...
var _parseInt = __webpack_require__(119);
...
var _ContainBlot2 = __webpack_require__(22);
...
var _TableCellBlot = __webpack_require__(43);
...
var _TableTrick = __webpack_require__(39);
...
window.Quill = __webpack_require__(3);
var quillTable = __webpack_require__(72);
            ...
            bindings: {
                td: {
                    ...
                    handler: function handler(range, keycontext) {
                        ...
                        var _quill$getLine3 = quill.getLine(range.index + range.length),
                        ...
                        var _quill$getLine5 = quill.getLine(range.index - 1),
                            _quill$getLine6 = (0, _slicedToArray3.default)(_quill$getLine5, 1),
                            prev = _quill$getLine6[0];
...
var _quillDelta = __webpack_require__(73);
...
var _TableRowBlot = __webpack_require__(58);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(45)(Function.call, __webpack_require__(38).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
